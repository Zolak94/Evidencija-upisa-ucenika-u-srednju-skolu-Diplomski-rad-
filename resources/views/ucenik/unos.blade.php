        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('ucenici.store') }}" autocomplete="off">
                            @csrf
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    <label>Ime i prezime*</label>
                                    <input type="text" class="form-control" name="ime_prezime" value="{{ old('ime_prezime')}}"
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    ...
                                    <input class="flatpickr form-control input active" type="text" id="datum_rodjenja"
                                        name="datum_rodjenja" value="{{ old('datum_rodjenja')}}"
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pol" value="2" @if(old('pol') == 2) checked @endif>
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    <label>JMBG*</label>
                                    <input type="number" class="form-control" name="jmbg" value="{{ old('jmbg')}}"
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="broj_bodova" value="{{ old('broj_bodova')}}"
