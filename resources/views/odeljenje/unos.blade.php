        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('odeljenja.store') }}" autocomplete="off">
                            @csrf
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    <label>Naziv*</label>
                                    <input type="text" class="form-control" name="naziv" value="{{ old('naziv')}}"
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    ...
                                    <select name="staresina_id" id="staresina_id" class="combobox form-control"
                                        ...
                                        <option value="{{$staresina->id}}" @if(old('staresina_id')==$staresina->id) selected="selected"  @endif >{{$staresina->ime_prezime}}</option>
                                        @endforeach
                                    </select>
                                    @error('staresina_id')
                            ...
                            <div class="form-group">
                                <div class="offset-md-3 col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="broj_ucenika" value="{{ old('broj_ucenika')}}"
