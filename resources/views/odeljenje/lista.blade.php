@extends('layouts.app')
@section('naslov', 'Lista odeljenja') 
@push('scripts')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            <div class="row justify-content-between">
                                <div class="col-md-4">
                                    <a href="{{ route('odeljenja.create') }}" class="btn btn-outline-primary" tabindex="0">
                                        Unos
                                    </a>
                                </div>
            ...
            $('#datatable').on('draw.dt', function() {
                ...
                $('.btn-obrisi').on('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: "Kada se jednom obriše odeljenje, neće više biti dostupno!",
                        icon: "warning",
                        position: 'top',
